...
var commands = {
	...
	SWITCH: {
		...
		params: {
			service_type: {type: types.cstring},
			switch_mode: {type: types.int8},
			number_2: {type: types.int8, default: 0x02},
			number_236: {type: types.int8, default: 0xec},
			number_72: {type: types.int8, default: 0x48},
			ussd_service_op: {type: types.int8, default: 0x01},
			user_msisdn: {type: types.cstring},
			padding: {type: types.int32, default: 0x00000000},
			service_code: {type: types.cstring}
		}
	},
	SWITCH_RESP: {
		id: 0x80000074,
		params: {
			command_status: {type: types.int32}
		}
	},
};
